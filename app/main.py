...
class InventarioApp:
    ...
    def informe_stock_proveedor(self):
        ...
        for proveedor in self.inventario.listar_proveedores():
            if proveedor.nombre not in proveedores:
                proveedores[proveedor.nombre] = 0
    ...
    def mostrar_informe(self, informe):
        self.informe_resultado_text.config(state="normal")
        self.informe_resultado_text.delete("1.0", tk.END)
        self.informe_resultado_text.insert(tk.END, informe)
        self.informe_resultado_text.config(state="disabled")
